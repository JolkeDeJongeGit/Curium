...
class PipelineStateSky : public PipelineState
{
public:
	PipelineStateSky(const std::string& inVertexName, const std::string& inPixelName, const D3D12_PRIMITIVE_TOPOLOGY_TYPE inType, const bool inUseDepth = true);
